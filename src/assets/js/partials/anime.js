...
const AnimeJS = (options) => (animeModule.animate ? animeModule.animate(options?.targets, options) : options);
if (animeModule.stagger) {
    AnimeJS.stagger = animeModule.stagger;
}
